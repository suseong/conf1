...
% chad_a = int(wj*sq_d3trj_a + ws*sq_d4trj_a);
% chad_b = int(wj*sq_d3trj_b + ws*sq_d4trj_b);
% chad_c = int(wj*sq_d3trj_c + ws*sq_d4trj_c);
% chad_d = int(wj*sq_d3trj_d + ws*sq_d4trj_d);

syms t0 t1 t2 t3 t4 t5 real;
...
const(17) = subs(d2trj_a,t,0);
const(18) = subs(d2trj_a,t,t1) - subs(d2trj_b,t,0);
const(19) = subs(d2trj_b,t,t2) - subs(d2trj_c,t,0);
const(20) = subs(d2trj_c,t,t3) - subs(d2trj_d,t,0);
const(21) = subs(d2trj_d,t,t4);

const(22) = subs(d3trj_a,t,t0);
const(23) = subs(d3trj_a,t,t1) - subs(d3trj_b,t,0);
const(24) = subs(d3trj_b,t,t2) - subs(d3trj_c,t,0);
const(25) = subs(d3trj_c,t,t3) - subs(d3trj_d,t,0);
const(26) = subs(d3trj_d,t,t4);

const(27) = subs(d4trj_a,t,t0);
const(28) = subs(d4trj_a,t,t1) - subs(d4trj_b,t,0);
const(29) = subs(d4trj_b,t,t2) - subs(d4trj_c,t,0);
const(30) = subs(d4trj_c,t,t3) - subs(d4trj_d,t,0);
